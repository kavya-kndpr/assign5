...
if($sql)
                    {
                        echo '<script>alert("Data Added Successfully");window.location="p4view.php"</script>';
                    }
                    else
                    {
    ...
    echo '<script>alert("Passport Number Already Present");window.location="addpass.php"</script>';
}
}
?>
</body>
