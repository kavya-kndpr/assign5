...
include 'con_db.php';
    if($_POST)
    {
        ...
        if($row==0){
            echo '<script>alert("Passport Number not found");window.location="p4update.php"</script>';
        }
    }
?>
...
<body style="background-color: black;color: yellow;">
    ...
    <table border="1" style="text-align:left;">
        ...
        <tr>
            <th>Enter Passport Number</th><th><input type="text" name="passno" value="<?php echo $row['passno']; ?>"></th>
        </tr>
        <tr>
        ...
        <tr>
            <th>Enter Nationality</th><th><input type="text" name="nation" value="<?php echo $row['nation']; ?>"></th>
        </tr>
        <tr>
...
if($sql)
                    {
                        echo '<script>alert("Data Updated Successfully");window.location="viewpass.php"</script>';
                    }
                    else
                    {
